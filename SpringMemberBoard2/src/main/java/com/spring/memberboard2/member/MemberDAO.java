...
public class MemberDAO {
	...
	public int insertMember(MemberVO memberVO) {
		...
		try {
			...
			System.out.println("insertMember 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
	...
	public int userCheck(MemberVO memberVO) {
		...
		try {
			...
			System.out.println("userCheck 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
	...
	public ArrayList<MemberVO> getMemberlist() {
		...
		try {
			...
			System.out.println("getMemberlist 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
			JDBCUtil.closeResource(rs, pstmt, conn);
		}
	...
	public MemberVO selectMember(MemberVO memberVO) {
		...
		try {
			...
			System.out.println("selectMember 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
			JDBCUtil.closeResource(rs, pstmt, conn);
		}
	...
	public int deleteMember(MemberVO memberVO) {
		...
		try {
			...
			System.out.println("deleteMember 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
			JDBCUtil.closeResource(pstmt, conn);
		}
	...
	public int updateMember(MemberVO memberVO) {
		...
		try {
			...
			pstmt = conn.prepareStatement("update smember "
			...
			System.out.println("updateMember 오류" + ex.getMessage());
			ex.printStackTrace();
		} finally {
			JDBCUtil.closeResource(pstmt, conn);
		}
