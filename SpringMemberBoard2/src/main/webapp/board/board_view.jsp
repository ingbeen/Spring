<%@page import="com.spring.memberboard2.board.BoardVO"%>
...
<body>
	...
	<table align="center">
		...
		<tr>
			...
			<td style="font-family: 돋움; font-size: 12">
				<%if(!(boardVO.getOrg_file()==null)) { %>
				<a href="filedownload.bo?of=<%=boardVO.getUp_file() %>&of2=<%=boardVO.getOrg_file() %>"><%=boardVO.getOrg_file() %></a>
				<%} %>
			</td>
		</tr>
